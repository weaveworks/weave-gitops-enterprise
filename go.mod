...
require (
	...
	github.com/weaveworks/weave-gitops v0.26.1-0.20230704125950-a8f791b8a1f0
...
require (
	...
	github.com/fluxcd/notification-controller/api v1.0.0-rc.4 // indirect
...
replace (
	...
	// go: downgraded k8s.io/kubernetes v1.27.3 => v1.15.0-alpha.0
	//
