...
require (
	...
	github.com/weaveworks/cluster-api-provider-existinginfra v0.0.0-20201120150316-f0e8f722a3d3
	...
	github.com/weaveworks/wksctl v0.0.0-20201120151316-02f7d474f5d7
