...
require (
	...
	github.com/weaveworks/cluster-api-provider-existinginfra v0.0.3-0.20201009193405-484e006fe0f4
	...
	github.com/weaveworks/wksctl v0.9.0-alpha.4.0.20201009195534-9948892f0211
