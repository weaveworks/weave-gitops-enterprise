...
var file_api_pipelines_types_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_api_pipelines_types_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_pipelines_types_proto_goTypes = []interface{}{
	...
	(*PipelineStatus_EnvironmentStatus)(nil), // 11: pipelines.v1.PipelineStatus.EnvironmentStatus
	nil,                                      // 12: pipelines.v1.PipelineStatus.EnvironmentsEntry
}
var file_api_pipelines_types_proto_depIdxs = []int32{
	...
	12, // 5: pipelines.v1.PipelineStatus.environments:type_name -> pipelines.v1.PipelineStatus.EnvironmentsEntry
	...
	8,  // 10: pipelines.v1.PipelineStatus.EnvironmentStatus.waitingStatus:type_name -> pipelines.v1.WaitingStatus
	7,  // 11: pipelines.v1.PipelineStatus.EnvironmentStatus.targetsStatuses:type_name -> pipelines.v1.PipelineTargetStatus
	11, // 12: pipelines.v1.PipelineStatus.EnvironmentsEntry.value:type_name -> pipelines.v1.PipelineStatus.EnvironmentStatus
