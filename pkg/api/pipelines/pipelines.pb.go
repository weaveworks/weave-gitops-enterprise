...
var file_api_pipelines_pipelines_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x6e, 0x65, 0x52, 0x08, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x32, 0xee,
	0x01, 0x0a, 0x09, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x12, 0x6f, 0x0a, 0x0d,
	...
	0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42,
...
var file_api_pipelines_pipelines_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_pipelines_pipelines_proto_goTypes = []interface{}{
	...
	(*Pipeline)(nil),              // 4: pipelines.v1.Pipeline
}
var file_api_pipelines_pipelines_proto_depIdxs = []int32{
	4, // 0: pipelines.v1.ListPipelinesResponse.pipelines:type_name -> pipelines.v1.Pipeline
	4, // 1: pipelines.v1.GetPipelineResponse.pipeline:type_name -> pipelines.v1.Pipeline
	0, // 2: pipelines.v1.Pipelines.ListPipelines:input_type -> pipelines.v1.ListPipelinesRequest
	2, // 3: pipelines.v1.Pipelines.GetPipeline:input_type -> pipelines.v1.GetPipelineRequest
	1, // 4: pipelines.v1.Pipelines.ListPipelines:output_type -> pipelines.v1.ListPipelinesResponse
	3, // 5: pipelines.v1.Pipelines.GetPipeline:output_type -> pipelines.v1.GetPipelineResponse
