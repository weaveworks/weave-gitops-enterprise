...
var file_api_pipelines_pipelines_proto_rawDesc = []byte{
	...
	0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x43, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x45,
	0x72, 0x72, 0x6f, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63,
	...
	0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42, 0xbe, 0x01,
	...
	0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x92, 0x41, 0x7e,
	0x12, 0x58, 0x0a, 0x1a, 0x57, 0x65, 0x61, 0x76, 0x65, 0x20, 0x47, 0x69, 0x74, 0x4f, 0x70, 0x73,
	0x20, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x20, 0x41, 0x50, 0x49, 0x12, 0x35,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x73, 0x32, 0x03, 0x30, 0x2e, 0x31, 0x32, 0x10, 0x61, 0x70, 0x70, 0x6c,
...
var file_api_pipelines_pipelines_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_api_pipelines_pipelines_proto_goTypes = []interface{}{
	...
	(*Pipeline)(nil),              // 5: pipelines.v1.Pipeline
}
var file_api_pipelines_pipelines_proto_depIdxs = []int32{
	5, // 0: pipelines.v1.ListPipelinesResponse.pipelines:type_name -> pipelines.v1.Pipeline
	4, // 1: pipelines.v1.ListPipelinesResponse.errors:type_name -> pipelines.v1.ListError
	5, // 2: pipelines.v1.GetPipelineResponse.pipeline:type_name -> pipelines.v1.Pipeline
	...
	1, // 5: pipelines.v1.Pipelines.ListPipelines:output_type -> pipelines.v1.ListPipelinesResponse
	3, // 6: pipelines.v1.Pipelines.GetPipeline:output_type -> pipelines.v1.GetPipelineResponse
