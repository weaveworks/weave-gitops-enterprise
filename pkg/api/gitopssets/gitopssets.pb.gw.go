...
var (
	filter_GitOpsSets_GetInventory_0 = &utilities.DoubleArray{Encoding: map[string]int{"namespace": 0, "name": 1}, Base: []int{1, 2, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 2, 2, 3, 3}}
)

func request_GitOpsSets_GetInventory_0(ctx context.Context, marshaler runtime.Marshaler, client GitOpsSetsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_GitOpsSets_GetInventory_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_GitOpsSets_GetInventory_0(ctx context.Context, marshaler runtime.Marshaler, server GitOpsSetsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetInventoryRequest
	var metadata runtime.ServerMetadata
...
func RegisterGitOpsSetsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GitOpsSetsServer) error {
	...
	mux.Handle("GET", pattern_GitOpsSets_GetInventory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/gitopssets.v1.GitOpsSets/GetInventory", runtime.WithHTTPPathPattern("/v1/namespaces/{namespace}/gitopssets/{name}/inventory"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GitOpsSets_GetInventory_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_GitOpsSets_GetInventory_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGitOpsSetsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GitOpsSetsClient) error {
	...
	mux.Handle("GET", pattern_GitOpsSets_GetInventory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/gitopssets.v1.GitOpsSets/GetInventory", runtime.WithHTTPPathPattern("/v1/namespaces/{namespace}/gitopssets/{name}/inventory"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GitOpsSets_GetInventory_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_GitOpsSets_GetInventory_0 = runtime.ForwardResponseMessage
