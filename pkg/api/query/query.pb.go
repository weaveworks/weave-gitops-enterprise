...
var file_api_query_query_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xde,
	0x01, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x50, 0x0a, 0x07, 0x44, 0x6f, 0x51, 0x75,
	...
	0x75, 0x67, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2d, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x42,
...
var file_api_query_query_proto_depIdxs = []int32{
	...
	3, // 4: query.v1.Query.DebugGetAccessRules:input_type -> query.v1.DebugGetAccessRulesRequest
	1, // 5: query.v1.Query.DoQuery:output_type -> query.v1.QueryResponse
	4, // 6: query.v1.Query.DebugGetAccessRules:output_type -> query.v1.DebugGetAccessRulesResponse
