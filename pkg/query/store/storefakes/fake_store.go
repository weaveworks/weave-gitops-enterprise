...
func (fake *FakeStore) StoreAccessRules(arg1 []models.AccessRule) error {
...
func (fake *FakeStore) StoreAccessRulesCalls(stub func([]models.AccessRule) error) {
	fake.storeAccessRulesMutex.Lock()
	defer fake.storeAccessRulesMutex.Unlock()
	fake.StoreAccessRulesStub = stub
}

func (fake *FakeStore) StoreAccessRulesArgsForCall(i int) []models.AccessRule {
	fake.storeAccessRulesMutex.RLock()
	defer fake.storeAccessRulesMutex.RUnlock()
