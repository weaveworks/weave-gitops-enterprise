...
export enum CanaryGatesRequestAction {
  OPEN = "OPEN",
  CLOSE = "CLOSE",
}
...
export type CanaryHooksRequest = {
  name?: string
  namespace?: string
  phase?: string
...
export type CanaryHooksResponse = {
}

export type CanaryGatesRequest = {
  name?: string
  namespace?: string
  action?: CanaryGatesRequestAction
}

export type CanaryGatesResponse = {
}
...
export class ClustersService {
  ...
  static CanaryHooks(req: CanaryHooksRequest, initReq?: fm.InitReq): Promise<CanaryHooksResponse> {
    return fm.fetchReq<CanaryHooksRequest, CanaryHooksResponse>(`/v1/canary/hooks/${req["hookType"]}`, {...initReq, method: "POST", body: JSON.stringify(req)})
  }
  static CanaryGates(req: CanaryGatesRequest, initReq?: fm.InitReq): Promise<CanaryGatesResponse> {
    return fm.fetchReq<CanaryGatesRequest, CanaryGatesResponse>(`/v1/canary/gates`, {...initReq, method: "POST", body: JSON.stringify(req)})
  }
}