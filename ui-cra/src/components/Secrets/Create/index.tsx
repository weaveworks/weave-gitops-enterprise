...
import { clearCallbackState, getProviderTokenHeader } from '../../GitAuth/utils';
...
const CreateSecret = () => {
  ...
  const [, setSubmitType] = useState<string>('');
  ...
  }, [api, formData, getClusterAutomations, history, setNotifications]);
