  ...
  return (
    <Flex center wide>
      <MessageBox>
        ...
        <Spacer padding="xs" />
        <Text size="medium">
          To get started with this feature, follow the guide to install Flagger
          on your cluster(s).
        </Text>
        <Spacer padding="small" />
        <Text size="large" semiBold>
        ...
        <Text>
          ...
          run automated application analysis, testing, promotion, and rollback
          for deployment strategies such as Canary, A/B Testing, and Blue/Green.
        </Text>
        <Spacer padding="small" />
