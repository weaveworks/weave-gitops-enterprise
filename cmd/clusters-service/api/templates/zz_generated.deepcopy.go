...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceTemplateV1) DeepCopyInto(out *ResourceTemplateV1) {
	*out = *in
	in.RawExtension.DeepCopyInto(&out.RawExtension)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceTemplateV1.
func (in *ResourceTemplateV1) DeepCopy() *ResourceTemplateV1 {
	if in == nil {
		return nil
	}
	out := new(ResourceTemplateV1)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TemplateSpecV1) DeepCopyInto(out *TemplateSpecV1) {
	*out = *in
	...
	if in.ResourceTemplates != nil {
		in, out := &in.ResourceTemplates, &out.ResourceTemplates
		*out = make([]ResourceTemplateV1, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
