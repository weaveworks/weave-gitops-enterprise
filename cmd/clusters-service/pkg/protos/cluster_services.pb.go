...
var file_cluster_services_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xaf, 0x02, 0x0a, 0x11, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x41, 0x75, 0x74,
	...
	0x61, 0x74, 0x68, 0x22, 0x86, 0x01, 0x0a, 0x0d, 0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a,
	...
	0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0xbc, 0x01, 0x0a,
	...
	0x74, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x82, 0x01, 0x0a, 0x0b,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x3c, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x70, 0x61, 0x63, 0x65, 0x22, 0x3d, 0x0a, 0x09, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x39, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e,
	...
	0x4c, 0x22, 0x31, 0x0a, 0x19, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x72, 0x6f, 0x72, 0x32, 0xf8, 0x1a, 0x0a, 0x0f, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73,
	...
	0x2f, 0x6a, 0x6f, 0x62, 0x73, 0x2f, 0x7b, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x5b,
...
var file_cluster_services_proto_depIdxs = []int32{
	...
	49,  // 54: cluster_services.v1.Template.profiles:type_name -> cluster_services.v1.TemplateProfile
	54,  // 55: cluster_services.v1.CreateAutomationsPullRequestRequest.cluster_automations:type_name -> cluster_services.v1.ClusterAutomation
	33,  // 56: cluster_services.v1.ClusterAutomation.cluster:type_name -> cluster_services.v1.ClusterNamespacedName
	55,  // 57: cluster_services.v1.ClusterAutomation.kustomization:type_name -> cluster_services.v1.Kustomization
	57,  // 58: cluster_services.v1.ClusterAutomation.helm_release:type_name -> cluster_services.v1.HelmRelease
	61,  // 59: cluster_services.v1.Kustomization.metadata:type_name -> cluster_services.v1.Metadata
	56,  // 60: cluster_services.v1.Kustomization.spec:type_name -> cluster_services.v1.KustomizationSpec
	62,  // 61: cluster_services.v1.KustomizationSpec.source_ref:type_name -> cluster_services.v1.SourceRef
	61,  // 62: cluster_services.v1.HelmRelease.metadata:type_name -> cluster_services.v1.Metadata
	58,  // 63: cluster_services.v1.HelmRelease.spec:type_name -> cluster_services.v1.HelmReleaseSpec
	59,  // 64: cluster_services.v1.HelmReleaseSpec.chart:type_name -> cluster_services.v1.Chart
	60,  // 65: cluster_services.v1.Chart.spec:type_name -> cluster_services.v1.ChartSpec
	62,  // 66: cluster_services.v1.ChartSpec.source_ref:type_name -> cluster_services.v1.SourceRef
	64,  // 67: cluster_services.v1.Profile.maintainers:type_name -> cluster_services.v1.Maintainer
	98,  // 68: cluster_services.v1.Profile.annotations:type_name -> cluster_services.v1.Profile.AnnotationsEntry
	65,  // 69: cluster_services.v1.Profile.helm_repository:type_name -> cluster_services.v1.HelmRepository
	100, // 70: cluster_services.v1.PolicyParam.value:type_name -> google.protobuf.Any
	99,  // 71: cluster_services.v1.PolicyTargetLabel.values:type_name -> cluster_services.v1.PolicyTargetLabel.ValuesEntry
	72,  // 72: cluster_services.v1.PolicyTargets.labels:type_name -> cluster_services.v1.PolicyTargetLabel
	74,  // 73: cluster_services.v1.Policy.standards:type_name -> cluster_services.v1.PolicyStandard
	71,  // 74: cluster_services.v1.Policy.parameters:type_name -> cluster_services.v1.PolicyParam
	73,  // 75: cluster_services.v1.Policy.targets:type_name -> cluster_services.v1.PolicyTargets
	76,  // 76: cluster_services.v1.ListEventsRequest.involvedObject:type_name -> cluster_services.v1.ObjectRef
	77,  // 77: cluster_services.v1.ListEventsResponse.events:type_name -> cluster_services.v1.Event
	33,  // 78: cluster_services.v1.RepositoryRef.cluster:type_name -> cluster_services.v1.ClusterNamespacedName
	80,  // 79: cluster_services.v1.ListChartsForRepositoryRequest.repository:type_name -> cluster_services.v1.RepositoryRef
	82,  // 80: cluster_services.v1.ListChartsForRepositoryResponse.charts:type_name -> cluster_services.v1.RepositoryChart
	80,  // 81: cluster_services.v1.GetValuesForChartRequest.repository:type_name -> cluster_services.v1.RepositoryRef
	...
	29,  // 89: cluster_services.v1.ClustersService.CreatePullRequest:input_type -> cluster_services.v1.CreatePullRequestRequest
	31,  // 90: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:input_type -> cluster_services.v1.CreateTfControllerPullRequestRequest
	34,  // 91: cluster_services.v1.ClustersService.DeleteClustersPullRequest:input_type -> cluster_services.v1.DeleteClustersPullRequestRequest
	36,  // 92: cluster_services.v1.ClustersService.ListCredentials:input_type -> cluster_services.v1.ListCredentialsRequest
	38,  // 93: cluster_services.v1.ClustersService.GetKubeconfig:input_type -> cluster_services.v1.GetKubeconfigRequest
	51,  // 94: cluster_services.v1.ClustersService.GetEnterpriseVersion:input_type -> cluster_services.v1.GetEnterpriseVersionRequest
	53,  // 95: cluster_services.v1.ClustersService.CreateAutomationsPullRequest:input_type -> cluster_services.v1.CreateAutomationsPullRequestRequest
	68,  // 96: cluster_services.v1.ClustersService.GetConfig:input_type -> cluster_services.v1.GetConfigRequest
	...
	78,  // 101: cluster_services.v1.ClustersService.ListEvents:input_type -> cluster_services.v1.ListEventsRequest
	81,  // 102: cluster_services.v1.ClustersService.ListChartsForRepository:input_type -> cluster_services.v1.ListChartsForRepositoryRequest
	84,  // 103: cluster_services.v1.ClustersService.GetValuesForChart:input_type -> cluster_services.v1.GetValuesForChartRequest
	86,  // 104: cluster_services.v1.ClustersService.GetChartsJob:input_type -> cluster_services.v1.GetChartsJobRequest
	...
	30,  // 112: cluster_services.v1.ClustersService.CreatePullRequest:output_type -> cluster_services.v1.CreatePullRequestResponse
	32,  // 113: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:output_type -> cluster_services.v1.CreateTfControllerPullRequestResponse
	35,  // 114: cluster_services.v1.ClustersService.DeleteClustersPullRequest:output_type -> cluster_services.v1.DeleteClustersPullRequestResponse
	37,  // 115: cluster_services.v1.ClustersService.ListCredentials:output_type -> cluster_services.v1.ListCredentialsResponse
	101, // 116: cluster_services.v1.ClustersService.GetKubeconfig:output_type -> google.api.HttpBody
	52,  // 117: cluster_services.v1.ClustersService.GetEnterpriseVersion:output_type -> cluster_services.v1.GetEnterpriseVersionResponse
	63,  // 118: cluster_services.v1.ClustersService.CreateAutomationsPullRequest:output_type -> cluster_services.v1.CreateAutomationsPullRequestResponse
	69,  // 119: cluster_services.v1.ClustersService.GetConfig:output_type -> cluster_services.v1.GetConfigResponse
	...
	79,  // 124: cluster_services.v1.ClustersService.ListEvents:output_type -> cluster_services.v1.ListEventsResponse
	83,  // 125: cluster_services.v1.ClustersService.ListChartsForRepository:output_type -> cluster_services.v1.ListChartsForRepositoryResponse
	85,  // 126: cluster_services.v1.ClustersService.GetValuesForChart:output_type -> cluster_services.v1.GetValuesForChartResponse
	87,  // 127: cluster_services.v1.ClustersService.GetChartsJob:output_type -> cluster_services.v1.GetChartsJobResponse
