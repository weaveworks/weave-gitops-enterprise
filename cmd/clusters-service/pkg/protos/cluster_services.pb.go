...
var file_cluster_services_proto_msgTypes = make([]protoimpl.MessageInfo, 99)
var file_cluster_services_proto_goTypes = []interface{}{
	...
	(*PolicyValidation)(nil),                      // 27: cluster_services.v1.PolicyValidation
	(*CreatePullRequestRequest)(nil),              // 28: cluster_services.v1.CreatePullRequestRequest
	(*CreatePullRequestResponse)(nil),             // 29: cluster_services.v1.CreatePullRequestResponse
	...
	(*CapiClusterInfrastructureRef)(nil),          // 43: cluster_services.v1.CapiClusterInfrastructureRef
	(*GitopsClusterRef)(nil),                      // 44: cluster_services.v1.GitopsClusterRef
	(*Credential)(nil),                            // 45: cluster_services.v1.Credential
	(*Template)(nil),                              // 46: cluster_services.v1.Template
	(*Parameter)(nil),                             // 47: cluster_services.v1.Parameter
	(*TemplateProfile)(nil),                       // 48: cluster_services.v1.TemplateProfile
	(*TemplateObject)(nil),                        // 49: cluster_services.v1.TemplateObject
	(*GetEnterpriseVersionRequest)(nil),           // 50: cluster_services.v1.GetEnterpriseVersionRequest
	(*GetEnterpriseVersionResponse)(nil),          // 51: cluster_services.v1.GetEnterpriseVersionResponse
	(*CreateAutomationsPullRequestRequest)(nil),   // 52: cluster_services.v1.CreateAutomationsPullRequestRequest
	(*ClusterAutomation)(nil),                     // 53: cluster_services.v1.ClusterAutomation
	(*Kustomization)(nil),                         // 54: cluster_services.v1.Kustomization
	(*KustomizationSpec)(nil),                     // 55: cluster_services.v1.KustomizationSpec
	(*HelmRelease)(nil),                           // 56: cluster_services.v1.HelmRelease
	(*HelmReleaseSpec)(nil),                       // 57: cluster_services.v1.HelmReleaseSpec
	(*Chart)(nil),                                 // 58: cluster_services.v1.Chart
	(*ChartSpec)(nil),                             // 59: cluster_services.v1.ChartSpec
	(*Metadata)(nil),                              // 60: cluster_services.v1.Metadata
	(*SourceRef)(nil),                             // 61: cluster_services.v1.SourceRef
	(*CreateAutomationsPullRequestResponse)(nil),  // 62: cluster_services.v1.CreateAutomationsPullRequestResponse
	(*Maintainer)(nil),                            // 63: cluster_services.v1.Maintainer
	(*HelmRepository)(nil),                        // 64: cluster_services.v1.HelmRepository
	(*Profile)(nil),                               // 65: cluster_services.v1.Profile
	(*ProfileValues)(nil),                         // 66: cluster_services.v1.ProfileValues
	(*GetConfigRequest)(nil),                      // 67: cluster_services.v1.GetConfigRequest
	(*GetConfigResponse)(nil),                     // 68: cluster_services.v1.GetConfigResponse
	(*PolicyParamRepeatedString)(nil),             // 69: cluster_services.v1.PolicyParamRepeatedString
	(*PolicyParam)(nil),                           // 70: cluster_services.v1.PolicyParam
	(*PolicyTargetLabel)(nil),                     // 71: cluster_services.v1.PolicyTargetLabel
	(*PolicyTargets)(nil),                         // 72: cluster_services.v1.PolicyTargets
	(*PolicyStandard)(nil),                        // 73: cluster_services.v1.PolicyStandard
	(*Policy)(nil),                                // 74: cluster_services.v1.Policy
	(*ObjectRef)(nil),                             // 75: cluster_services.v1.ObjectRef
	(*Event)(nil),                                 // 76: cluster_services.v1.Event
	(*ListEventsRequest)(nil),                     // 77: cluster_services.v1.ListEventsRequest
	(*ListEventsResponse)(nil),                    // 78: cluster_services.v1.ListEventsResponse
	(*RepositoryRef)(nil),                         // 79: cluster_services.v1.RepositoryRef
	(*ListChartsForRepositoryRequest)(nil),        // 80: cluster_services.v1.ListChartsForRepositoryRequest
	(*RepositoryChart)(nil),                       // 81: cluster_services.v1.RepositoryChart
	(*ListChartsForRepositoryResponse)(nil),       // 82: cluster_services.v1.ListChartsForRepositoryResponse
	(*GetValuesForChartRequest)(nil),              // 83: cluster_services.v1.GetValuesForChartRequest
	(*GetValuesForChartResponse)(nil),             // 84: cluster_services.v1.GetValuesForChartResponse
	(*GetChartsJobRequest)(nil),                   // 85: cluster_services.v1.GetChartsJobRequest
	(*GetChartsJobResponse)(nil),                  // 86: cluster_services.v1.GetChartsJobResponse
	nil,                                           // 87: cluster_services.v1.RenderTemplateRequest.ValuesEntry
	(*CostEstimate_Range)(nil),                    // 88: cluster_services.v1.CostEstimate.Range
	nil,                                           // 89: cluster_services.v1.CreatePullRequestRequest.ParameterValuesEntry
	nil,                                           // 90: cluster_services.v1.CreateTfControllerPullRequestRequest.ParameterValuesEntry
	nil,                                           // 91: cluster_services.v1.GitopsCluster.AnnotationsEntry
	nil,                                           // 92: cluster_services.v1.GitopsCluster.LabelsEntry
	nil,                                           // 93: cluster_services.v1.CapiCluster.AnnotationsEntry
	nil,                                           // 94: cluster_services.v1.CapiCluster.LabelsEntry
	nil,                                           // 95: cluster_services.v1.Template.AnnotationsEntry
	nil,                                           // 96: cluster_services.v1.Template.LabelsEntry
	nil,                                           // 97: cluster_services.v1.Profile.AnnotationsEntry
	nil,                                           // 98: cluster_services.v1.PolicyTargetLabel.ValuesEntry
...
var file_cluster_services_proto_depIdxs = []int32{
	46,  // 0: cluster_services.v1.ListTemplatesResponse.templates:type_name -> cluster_services.v1.Template
	2,   // 1: cluster_services.v1.ListTemplatesResponse.errors:type_name -> cluster_services.v1.ListError
	46,  // 2: cluster_services.v1.GetTemplateResponse.template:type_name -> cluster_services.v1.Template
	47,  // 3: cluster_services.v1.ListTemplateParamsResponse.parameters:type_name -> cluster_services.v1.Parameter
	49,  // 4: cluster_services.v1.ListTemplateParamsResponse.objects:type_name -> cluster_services.v1.TemplateObject
	48,  // 5: cluster_services.v1.ListTemplateProfilesResponse.profiles:type_name -> cluster_services.v1.TemplateProfile
	49,  // 6: cluster_services.v1.ListTemplateProfilesResponse.objects:type_name -> cluster_services.v1.TemplateObject
	87,  // 7: cluster_services.v1.RenderTemplateRequest.values:type_name -> cluster_services.v1.RenderTemplateRequest.ValuesEntry
	45,  // 8: cluster_services.v1.RenderTemplateRequest.credentials:type_name -> cluster_services.v1.Credential
	66,  // 9: cluster_services.v1.RenderTemplateRequest.profiles:type_name -> cluster_services.v1.ProfileValues
	54,  // 10: cluster_services.v1.RenderTemplateRequest.kustomizations:type_name -> cluster_services.v1.Kustomization
	88,  // 11: cluster_services.v1.CostEstimate.range:type_name -> cluster_services.v1.CostEstimate.Range
	...
	53,  // 15: cluster_services.v1.RenderAutomationRequest.cluster_automations:type_name -> cluster_services.v1.ClusterAutomation
	...
	40,  // 18: cluster_services.v1.ListGitopsClustersResponse.gitops_clusters:type_name -> cluster_services.v1.GitopsCluster
	...
	74,  // 21: cluster_services.v1.GetPolicyResponse.policy:type_name -> cluster_services.v1.Policy
	74,  // 22: cluster_services.v1.ListPoliciesResponse.policies:type_name -> cluster_services.v1.Policy
	...
	27,  // 25: cluster_services.v1.ListPolicyValidationsResponse.violations:type_name -> cluster_services.v1.PolicyValidation
	2,   // 26: cluster_services.v1.ListPolicyValidationsResponse.errors:type_name -> cluster_services.v1.ListError
	27,  // 27: cluster_services.v1.GetPolicyValidationResponse.violation:type_name -> cluster_services.v1.PolicyValidation
	26,  // 28: cluster_services.v1.PolicyValidation.occurrences:type_name -> cluster_services.v1.PolicyValidationOccurrence
	89,  // 29: cluster_services.v1.CreatePullRequestRequest.parameter_values:type_name -> cluster_services.v1.CreatePullRequestRequest.ParameterValuesEntry
	45,  // 30: cluster_services.v1.CreatePullRequestRequest.credentials:type_name -> cluster_services.v1.Credential
	66,  // 31: cluster_services.v1.CreatePullRequestRequest.values:type_name -> cluster_services.v1.ProfileValues
	54,  // 32: cluster_services.v1.CreatePullRequestRequest.kustomizations:type_name -> cluster_services.v1.Kustomization
	90,  // 33: cluster_services.v1.CreateTfControllerPullRequestRequest.parameter_values:type_name -> cluster_services.v1.CreateTfControllerPullRequestRequest.ParameterValuesEntry
	45,  // 34: cluster_services.v1.DeleteClustersPullRequestRequest.credentials:type_name -> cluster_services.v1.Credential
	32,  // 35: cluster_services.v1.DeleteClustersPullRequestRequest.cluster_namespaced_names:type_name -> cluster_services.v1.ClusterNamespacedName
	45,  // 36: cluster_services.v1.ListCredentialsResponse.credentials:type_name -> cluster_services.v1.Credential
	91,  // 37: cluster_services.v1.GitopsCluster.annotations:type_name -> cluster_services.v1.GitopsCluster.AnnotationsEntry
	92,  // 38: cluster_services.v1.GitopsCluster.labels:type_name -> cluster_services.v1.GitopsCluster.LabelsEntry
	39,  // 39: cluster_services.v1.GitopsCluster.conditions:type_name -> cluster_services.v1.Condition
	44,  // 40: cluster_services.v1.GitopsCluster.capiClusterRef:type_name -> cluster_services.v1.GitopsClusterRef
	44,  // 41: cluster_services.v1.GitopsCluster.secretRef:type_name -> cluster_services.v1.GitopsClusterRef
	41,  // 42: cluster_services.v1.GitopsCluster.capi_cluster:type_name -> cluster_services.v1.CapiCluster
	93,  // 43: cluster_services.v1.CapiCluster.annotations:type_name -> cluster_services.v1.CapiCluster.AnnotationsEntry
	94,  // 44: cluster_services.v1.CapiCluster.labels:type_name -> cluster_services.v1.CapiCluster.LabelsEntry
	42,  // 45: cluster_services.v1.CapiCluster.status:type_name -> cluster_services.v1.CapiClusterStatus
	43,  // 46: cluster_services.v1.CapiCluster.infrastructureRef:type_name -> cluster_services.v1.CapiClusterInfrastructureRef
	39,  // 47: cluster_services.v1.CapiClusterStatus.conditions:type_name -> cluster_services.v1.Condition
	47,  // 48: cluster_services.v1.Template.parameters:type_name -> cluster_services.v1.Parameter
	49,  // 49: cluster_services.v1.Template.objects:type_name -> cluster_services.v1.TemplateObject
	95,  // 50: cluster_services.v1.Template.annotations:type_name -> cluster_services.v1.Template.AnnotationsEntry
	96,  // 51: cluster_services.v1.Template.labels:type_name -> cluster_services.v1.Template.LabelsEntry
	53,  // 52: cluster_services.v1.CreateAutomationsPullRequestRequest.cluster_automations:type_name -> cluster_services.v1.ClusterAutomation
	32,  // 53: cluster_services.v1.ClusterAutomation.cluster:type_name -> cluster_services.v1.ClusterNamespacedName
	54,  // 54: cluster_services.v1.ClusterAutomation.kustomization:type_name -> cluster_services.v1.Kustomization
	56,  // 55: cluster_services.v1.ClusterAutomation.helm_release:type_name -> cluster_services.v1.HelmRelease
	60,  // 56: cluster_services.v1.Kustomization.metadata:type_name -> cluster_services.v1.Metadata
	55,  // 57: cluster_services.v1.Kustomization.spec:type_name -> cluster_services.v1.KustomizationSpec
	61,  // 58: cluster_services.v1.KustomizationSpec.source_ref:type_name -> cluster_services.v1.SourceRef
	60,  // 59: cluster_services.v1.HelmRelease.metadata:type_name -> cluster_services.v1.Metadata
	57,  // 60: cluster_services.v1.HelmRelease.spec:type_name -> cluster_services.v1.HelmReleaseSpec
	58,  // 61: cluster_services.v1.HelmReleaseSpec.chart:type_name -> cluster_services.v1.Chart
	59,  // 62: cluster_services.v1.Chart.spec:type_name -> cluster_services.v1.ChartSpec
	61,  // 63: cluster_services.v1.ChartSpec.source_ref:type_name -> cluster_services.v1.SourceRef
	63,  // 64: cluster_services.v1.Profile.maintainers:type_name -> cluster_services.v1.Maintainer
	97,  // 65: cluster_services.v1.Profile.annotations:type_name -> cluster_services.v1.Profile.AnnotationsEntry
	64,  // 66: cluster_services.v1.Profile.helm_repository:type_name -> cluster_services.v1.HelmRepository
	99,  // 67: cluster_services.v1.PolicyParam.value:type_name -> google.protobuf.Any
	98,  // 68: cluster_services.v1.PolicyTargetLabel.values:type_name -> cluster_services.v1.PolicyTargetLabel.ValuesEntry
	71,  // 69: cluster_services.v1.PolicyTargets.labels:type_name -> cluster_services.v1.PolicyTargetLabel
	73,  // 70: cluster_services.v1.Policy.standards:type_name -> cluster_services.v1.PolicyStandard
	70,  // 71: cluster_services.v1.Policy.parameters:type_name -> cluster_services.v1.PolicyParam
	72,  // 72: cluster_services.v1.Policy.targets:type_name -> cluster_services.v1.PolicyTargets
	75,  // 73: cluster_services.v1.ListEventsRequest.involvedObject:type_name -> cluster_services.v1.ObjectRef
	76,  // 74: cluster_services.v1.ListEventsResponse.events:type_name -> cluster_services.v1.Event
	32,  // 75: cluster_services.v1.RepositoryRef.cluster:type_name -> cluster_services.v1.ClusterNamespacedName
	79,  // 76: cluster_services.v1.ListChartsForRepositoryRequest.repository:type_name -> cluster_services.v1.RepositoryRef
	81,  // 77: cluster_services.v1.ListChartsForRepositoryResponse.charts:type_name -> cluster_services.v1.RepositoryChart
	79,  // 78: cluster_services.v1.GetValuesForChartRequest.repository:type_name -> cluster_services.v1.RepositoryRef
	0,   // 79: cluster_services.v1.ClustersService.ListTemplates:input_type -> cluster_services.v1.ListTemplatesRequest
	4,   // 80: cluster_services.v1.ClustersService.GetTemplate:input_type -> cluster_services.v1.GetTemplateRequest
	6,   // 81: cluster_services.v1.ClustersService.ListTemplateParams:input_type -> cluster_services.v1.ListTemplateParamsRequest
	8,   // 82: cluster_services.v1.ClustersService.ListTemplateProfiles:input_type -> cluster_services.v1.ListTemplateProfilesRequest
	10,  // 83: cluster_services.v1.ClustersService.RenderTemplate:input_type -> cluster_services.v1.RenderTemplateRequest
	14,  // 84: cluster_services.v1.ClustersService.RenderAutomation:input_type -> cluster_services.v1.RenderAutomationRequest
	16,  // 85: cluster_services.v1.ClustersService.ListGitopsClusters:input_type -> cluster_services.v1.ListGitopsClustersRequest
	28,  // 86: cluster_services.v1.ClustersService.CreatePullRequest:input_type -> cluster_services.v1.CreatePullRequestRequest
	30,  // 87: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:input_type -> cluster_services.v1.CreateTfControllerPullRequestRequest
	33,  // 88: cluster_services.v1.ClustersService.DeleteClustersPullRequest:input_type -> cluster_services.v1.DeleteClustersPullRequestRequest
	35,  // 89: cluster_services.v1.ClustersService.ListCredentials:input_type -> cluster_services.v1.ListCredentialsRequest
	37,  // 90: cluster_services.v1.ClustersService.GetKubeconfig:input_type -> cluster_services.v1.GetKubeconfigRequest
	50,  // 91: cluster_services.v1.ClustersService.GetEnterpriseVersion:input_type -> cluster_services.v1.GetEnterpriseVersionRequest
	52,  // 92: cluster_services.v1.ClustersService.CreateAutomationsPullRequest:input_type -> cluster_services.v1.CreateAutomationsPullRequestRequest
	67,  // 93: cluster_services.v1.ClustersService.GetConfig:input_type -> cluster_services.v1.GetConfigRequest
	19,  // 94: cluster_services.v1.ClustersService.ListPolicies:input_type -> cluster_services.v1.ListPoliciesRequest
	18,  // 95: cluster_services.v1.ClustersService.GetPolicy:input_type -> cluster_services.v1.GetPolicyRequest
	22,  // 96: cluster_services.v1.ClustersService.ListPolicyValidations:input_type -> cluster_services.v1.ListPolicyValidationsRequest
	24,  // 97: cluster_services.v1.ClustersService.GetPolicyValidation:input_type -> cluster_services.v1.GetPolicyValidationRequest
	77,  // 98: cluster_services.v1.ClustersService.ListEvents:input_type -> cluster_services.v1.ListEventsRequest
	80,  // 99: cluster_services.v1.ClustersService.ListChartsForRepository:input_type -> cluster_services.v1.ListChartsForRepositoryRequest
	83,  // 100: cluster_services.v1.ClustersService.GetValuesForChart:input_type -> cluster_services.v1.GetValuesForChartRequest
	85,  // 101: cluster_services.v1.ClustersService.GetChartsJob:input_type -> cluster_services.v1.GetChartsJobRequest
	3,   // 102: cluster_services.v1.ClustersService.ListTemplates:output_type -> cluster_services.v1.ListTemplatesResponse
	5,   // 103: cluster_services.v1.ClustersService.GetTemplate:output_type -> cluster_services.v1.GetTemplateResponse
	7,   // 104: cluster_services.v1.ClustersService.ListTemplateParams:output_type -> cluster_services.v1.ListTemplateParamsResponse
	9,   // 105: cluster_services.v1.ClustersService.ListTemplateProfiles:output_type -> cluster_services.v1.ListTemplateProfilesResponse
	13,  // 106: cluster_services.v1.ClustersService.RenderTemplate:output_type -> cluster_services.v1.RenderTemplateResponse
	15,  // 107: cluster_services.v1.ClustersService.RenderAutomation:output_type -> cluster_services.v1.RenderAutomationResponse
	17,  // 108: cluster_services.v1.ClustersService.ListGitopsClusters:output_type -> cluster_services.v1.ListGitopsClustersResponse
	29,  // 109: cluster_services.v1.ClustersService.CreatePullRequest:output_type -> cluster_services.v1.CreatePullRequestResponse
	31,  // 110: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:output_type -> cluster_services.v1.CreateTfControllerPullRequestResponse
	34,  // 111: cluster_services.v1.ClustersService.DeleteClustersPullRequest:output_type -> cluster_services.v1.DeleteClustersPullRequestResponse
	36,  // 112: cluster_services.v1.ClustersService.ListCredentials:output_type -> cluster_services.v1.ListCredentialsResponse
	100, // 113: cluster_services.v1.ClustersService.GetKubeconfig:output_type -> google.api.HttpBody
	51,  // 114: cluster_services.v1.ClustersService.GetEnterpriseVersion:output_type -> cluster_services.v1.GetEnterpriseVersionResponse
	62,  // 115: cluster_services.v1.ClustersService.CreateAutomationsPullRequest:output_type -> cluster_services.v1.CreateAutomationsPullRequestResponse
	68,  // 116: cluster_services.v1.ClustersService.GetConfig:output_type -> cluster_services.v1.GetConfigResponse
	21,  // 117: cluster_services.v1.ClustersService.ListPolicies:output_type -> cluster_services.v1.ListPoliciesResponse
	20,  // 118: cluster_services.v1.ClustersService.GetPolicy:output_type -> cluster_services.v1.GetPolicyResponse
	23,  // 119: cluster_services.v1.ClustersService.ListPolicyValidations:output_type -> cluster_services.v1.ListPolicyValidationsResponse
	25,  // 120: cluster_services.v1.ClustersService.GetPolicyValidation:output_type -> cluster_services.v1.GetPolicyValidationResponse
	78,  // 121: cluster_services.v1.ClustersService.ListEvents:output_type -> cluster_services.v1.ListEventsResponse
	82,  // 122: cluster_services.v1.ClustersService.ListChartsForRepository:output_type -> cluster_services.v1.ListChartsForRepositoryResponse
	84,  // 123: cluster_services.v1.ClustersService.GetValuesForChart:output_type -> cluster_services.v1.GetValuesForChartResponse
	86,  // 124: cluster_services.v1.ClustersService.GetChartsJob:output_type -> cluster_services.v1.GetChartsJobResponse
