...
var file_cluster_services_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x32, 0xfc, 0x1b, 0x0a, 0x0f, 0x43, 0x6c,
...
>>>>>>> 58198a4f (add list workspaces api)
	...
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x42, 0x5b, 0x5a, 0x59, 0x67, 0x69, 0x74, 0x68,
...
var file_cluster_services_proto_msgTypes = make([]protoimpl.MessageInfo, 103)
var file_cluster_services_proto_goTypes = []interface{}{
	...
	nil,                                           // 91: cluster_services.v1.RenderTemplateRequest.ValuesEntry
	(*CostEstimate_Range)(nil),                    // 92: cluster_services.v1.CostEstimate.Range
	nil,                                           // 93: cluster_services.v1.CreatePullRequestRequest.ParameterValuesEntry
	nil,                                           // 94: cluster_services.v1.CreateTfControllerPullRequestRequest.ParameterValuesEntry
	nil,                                           // 95: cluster_services.v1.GitopsCluster.AnnotationsEntry
	nil,                                           // 96: cluster_services.v1.GitopsCluster.LabelsEntry
	nil,                                           // 97: cluster_services.v1.CapiCluster.AnnotationsEntry
	nil,                                           // 98: cluster_services.v1.CapiCluster.LabelsEntry
	nil,                                           // 99: cluster_services.v1.Template.AnnotationsEntry
	nil,                                           // 100: cluster_services.v1.Template.LabelsEntry
	nil,                                           // 101: cluster_services.v1.Profile.AnnotationsEntry
	nil,                                           // 102: cluster_services.v1.PolicyTargetLabel.ValuesEntry
...
var file_cluster_services_proto_depIdxs = []int32{
	...
	91,  // 7: cluster_services.v1.RenderTemplateRequest.values:type_name -> cluster_services.v1.RenderTemplateRequest.ValuesEntry
	...
	92,  // 11: cluster_services.v1.CostEstimate.range:type_name -> cluster_services.v1.CostEstimate.Range
	...
	103, // 28: cluster_services.v1.PolicyValidationParam.value:type_name -> google.protobuf.Any
	...
	93,  // 31: cluster_services.v1.CreatePullRequestRequest.parameter_values:type_name -> cluster_services.v1.CreatePullRequestRequest.ParameterValuesEntry
	...
	94,  // 35: cluster_services.v1.CreateTfControllerPullRequestRequest.parameter_values:type_name -> cluster_services.v1.CreateTfControllerPullRequestRequest.ParameterValuesEntry
	...
	95,  // 39: cluster_services.v1.GitopsCluster.annotations:type_name -> cluster_services.v1.GitopsCluster.AnnotationsEntry
	96,  // 40: cluster_services.v1.GitopsCluster.labels:type_name -> cluster_services.v1.GitopsCluster.LabelsEntry
	...
	97,  // 45: cluster_services.v1.CapiCluster.annotations:type_name -> cluster_services.v1.CapiCluster.AnnotationsEntry
	98,  // 46: cluster_services.v1.CapiCluster.labels:type_name -> cluster_services.v1.CapiCluster.LabelsEntry
	...
	99,  // 52: cluster_services.v1.Template.annotations:type_name -> cluster_services.v1.Template.AnnotationsEntry
	100, // 53: cluster_services.v1.Template.labels:type_name -> cluster_services.v1.Template.LabelsEntry
	...
	101, // 67: cluster_services.v1.Profile.annotations:type_name -> cluster_services.v1.Profile.AnnotationsEntry
	65,  // 68: cluster_services.v1.Profile.helm_repository:type_name -> cluster_services.v1.HelmRepository
	103, // 69: cluster_services.v1.PolicyParam.value:type_name -> google.protobuf.Any
	102, // 70: cluster_services.v1.PolicyTargetLabel.values:type_name -> cluster_services.v1.PolicyTargetLabel.ValuesEntry
	...
	0,   // 84: cluster_services.v1.ClustersService.ListTemplates:input_type -> cluster_services.v1.ListTemplatesRequest
	4,   // 85: cluster_services.v1.ClustersService.GetTemplate:input_type -> cluster_services.v1.GetTemplateRequest
	6,   // 86: cluster_services.v1.ClustersService.ListTemplateParams:input_type -> cluster_services.v1.ListTemplateParamsRequest
	8,   // 87: cluster_services.v1.ClustersService.ListTemplateProfiles:input_type -> cluster_services.v1.ListTemplateProfilesRequest
	10,  // 88: cluster_services.v1.ClustersService.RenderTemplate:input_type -> cluster_services.v1.RenderTemplateRequest
	14,  // 89: cluster_services.v1.ClustersService.RenderAutomation:input_type -> cluster_services.v1.RenderAutomationRequest
	16,  // 90: cluster_services.v1.ClustersService.ListGitopsClusters:input_type -> cluster_services.v1.ListGitopsClustersRequest
	29,  // 91: cluster_services.v1.ClustersService.CreatePullRequest:input_type -> cluster_services.v1.CreatePullRequestRequest
	31,  // 92: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:input_type -> cluster_services.v1.CreateTfControllerPullRequestRequest
	34,  // 93: cluster_services.v1.ClustersService.DeleteClustersPullRequest:input_type -> cluster_services.v1.DeleteClustersPullRequestRequest
	36,  // 94: cluster_services.v1.ClustersService.ListCredentials:input_type -> cluster_services.v1.ListCredentialsRequest
	38,  // 95: cluster_services.v1.ClustersService.GetKubeconfig:input_type -> cluster_services.v1.GetKubeconfigRequest
	51,  // 96: cluster_services.v1.ClustersService.GetEnterpriseVersion:input_type -> cluster_services.v1.GetEnterpriseVersionRequest
	53,  // 97: cluster_services.v1.ClustersService.CreateAutomationsPullRequest:input_type -> cluster_services.v1.CreateAutomationsPullRequestRequest
	68,  // 98: cluster_services.v1.ClustersService.GetConfig:input_type -> cluster_services.v1.GetConfigRequest
	19,  // 99: cluster_services.v1.ClustersService.ListPolicies:input_type -> cluster_services.v1.ListPoliciesRequest
	18,  // 100: cluster_services.v1.ClustersService.GetPolicy:input_type -> cluster_services.v1.GetPolicyRequest
	22,  // 101: cluster_services.v1.ClustersService.ListPolicyValidations:input_type -> cluster_services.v1.ListPolicyValidationsRequest
	24,  // 102: cluster_services.v1.ClustersService.GetPolicyValidation:input_type -> cluster_services.v1.GetPolicyValidationRequest
	78,  // 103: cluster_services.v1.ClustersService.ListEvents:input_type -> cluster_services.v1.ListEventsRequest
	81,  // 104: cluster_services.v1.ClustersService.ListChartsForRepository:input_type -> cluster_services.v1.ListChartsForRepositoryRequest
	84,  // 105: cluster_services.v1.ClustersService.GetValuesForChart:input_type -> cluster_services.v1.GetValuesForChartRequest
	86,  // 106: cluster_services.v1.ClustersService.GetChartsJob:input_type -> cluster_services.v1.GetChartsJobRequest
	89,  // 107: cluster_services.v1.ClustersService.ListWorkspaces:input_type -> cluster_services.v1.ListWorkspacesRequest
	3,   // 108: cluster_services.v1.ClustersService.ListTemplates:output_type -> cluster_services.v1.ListTemplatesResponse
	5,   // 109: cluster_services.v1.ClustersService.GetTemplate:output_type -> cluster_services.v1.GetTemplateResponse
	7,   // 110: cluster_services.v1.ClustersService.ListTemplateParams:output_type -> cluster_services.v1.ListTemplateParamsResponse
	9,   // 111: cluster_services.v1.ClustersService.ListTemplateProfiles:output_type -> cluster_services.v1.ListTemplateProfilesResponse
	13,  // 112: cluster_services.v1.ClustersService.RenderTemplate:output_type -> cluster_services.v1.RenderTemplateResponse
	15,  // 113: cluster_services.v1.ClustersService.RenderAutomation:output_type -> cluster_services.v1.RenderAutomationResponse
	17,  // 114: cluster_services.v1.ClustersService.ListGitopsClusters:output_type -> cluster_services.v1.ListGitopsClustersResponse
	30,  // 115: cluster_services.v1.ClustersService.CreatePullRequest:output_type -> cluster_services.v1.CreatePullRequestResponse
	32,  // 116: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:output_type -> cluster_services.v1.CreateTfControllerPullRequestResponse
	35,  // 117: cluster_services.v1.ClustersService.DeleteClustersPullRequest:output_type -> cluster_services.v1.DeleteClustersPullRequestResponse
	37,  // 118: cluster_services.v1.ClustersService.ListCredentials:output_type -> cluster_services.v1.ListCredentialsResponse
	104, // 119: cluster_services.v1.ClustersService.GetKubeconfig:output_type -> google.api.HttpBody
	52,  // 120: cluster_services.v1.ClustersService.GetEnterpriseVersion:output_type -> cluster_services.v1.GetEnterpriseVersionResponse
	63,  // 121: cluster_services.v1.ClustersService.CreateAutomationsPullRequest:output_type -> cluster_services.v1.CreateAutomationsPullRequestResponse
	69,  // 122: cluster_services.v1.ClustersService.GetConfig:output_type -> cluster_services.v1.GetConfigResponse
	21,  // 123: cluster_services.v1.ClustersService.ListPolicies:output_type -> cluster_services.v1.ListPoliciesResponse
	20,  // 124: cluster_services.v1.ClustersService.GetPolicy:output_type -> cluster_services.v1.GetPolicyResponse
	23,  // 125: cluster_services.v1.ClustersService.ListPolicyValidations:output_type -> cluster_services.v1.ListPolicyValidationsResponse
	25,  // 126: cluster_services.v1.ClustersService.GetPolicyValidation:output_type -> cluster_services.v1.GetPolicyValidationResponse
	79,  // 127: cluster_services.v1.ClustersService.ListEvents:output_type -> cluster_services.v1.ListEventsResponse
	83,  // 128: cluster_services.v1.ClustersService.ListChartsForRepository:output_type -> cluster_services.v1.ListChartsForRepositoryResponse
	85,  // 129: cluster_services.v1.ClustersService.GetValuesForChart:output_type -> cluster_services.v1.GetValuesForChartResponse
	87,  // 130: cluster_services.v1.ClustersService.GetChartsJob:output_type -> cluster_services.v1.GetChartsJobResponse
	90,  // 131: cluster_services.v1.ClustersService.ListWorkspaces:output_type -> cluster_services.v1.ListWorkspacesResponse
