...
var file_cluster_services_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x73, 0x32, 0xe0, 0x14, 0x0a, 0x0f, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73,
...
var file_cluster_services_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_cluster_services_proto_goTypes = []interface{}{
	...
	(*Maintainer)(nil),                            // 49: cluster_services.v1.Maintainer
	(*HelmRepository)(nil),                        // 50: cluster_services.v1.HelmRepository
	(*Profile)(nil),                               // 51: cluster_services.v1.Profile
	(*ProfileValues)(nil),                         // 52: cluster_services.v1.ProfileValues
	(*GetConfigRequest)(nil),                      // 53: cluster_services.v1.GetConfigRequest
	(*GetConfigResponse)(nil),                     // 54: cluster_services.v1.GetConfigResponse
	(*PolicyParamRepeatedString)(nil),             // 55: cluster_services.v1.PolicyParamRepeatedString
	(*PolicyParam)(nil),                           // 56: cluster_services.v1.PolicyParam
	(*PolicyTargetLabel)(nil),                     // 57: cluster_services.v1.PolicyTargetLabel
	(*PolicyTargets)(nil),                         // 58: cluster_services.v1.PolicyTargets
	(*PolicyStandard)(nil),                        // 59: cluster_services.v1.PolicyStandard
	(*Policy)(nil),                                // 60: cluster_services.v1.Policy
	(*ObjectRef)(nil),                             // 61: cluster_services.v1.ObjectRef
	(*Event)(nil),                                 // 62: cluster_services.v1.Event
	(*ListEventsRequest)(nil),                     // 63: cluster_services.v1.ListEventsRequest
	(*ListEventsResponse)(nil),                    // 64: cluster_services.v1.ListEventsResponse
	nil,                                           // 65: cluster_services.v1.RenderTemplateRequest.ValuesEntry
	nil,                                           // 66: cluster_services.v1.CreatePullRequestRequest.ParameterValuesEntry
	nil,                                           // 67: cluster_services.v1.CreateTfControllerPullRequestRequest.ParameterValuesEntry
	nil,                                           // 68: cluster_services.v1.GitopsCluster.AnnotationsEntry
	nil,                                           // 69: cluster_services.v1.GitopsCluster.LabelsEntry
	nil,                                           // 70: cluster_services.v1.CapiCluster.AnnotationsEntry
	nil,                                           // 71: cluster_services.v1.CapiCluster.LabelsEntry
	nil,                                           // 72: cluster_services.v1.Template.AnnotationsEntry
	nil,                                           // 73: cluster_services.v1.Profile.AnnotationsEntry
	nil,                                           // 74: cluster_services.v1.PolicyTargetLabel.ValuesEntry
	(*anypb.Any)(nil),                             // 75: google.protobuf.Any
	(*httpbody.HttpBody)(nil),                     // 76: google.api.HttpBody
}
var file_cluster_services_proto_depIdxs = []int32{
	...
	65, // 6: cluster_services.v1.RenderTemplateRequest.values:type_name -> cluster_services.v1.RenderTemplateRequest.ValuesEntry
	...
	60, // 10: cluster_services.v1.GetPolicyResponse.policy:type_name -> cluster_services.v1.Policy
	60, // 11: cluster_services.v1.ListPoliciesResponse.policies:type_name -> cluster_services.v1.Policy
	...
	66, // 18: cluster_services.v1.CreatePullRequestRequest.parameter_values:type_name -> cluster_services.v1.CreatePullRequestRequest.ParameterValuesEntry
	42, // 19: cluster_services.v1.CreatePullRequestRequest.credentials:type_name -> cluster_services.v1.Credential
	52, // 20: cluster_services.v1.CreatePullRequestRequest.values:type_name -> cluster_services.v1.ProfileValues
	...
	67, // 23: cluster_services.v1.CreateTfControllerPullRequestRequest.parameter_values:type_name -> cluster_services.v1.CreateTfControllerPullRequestRequest.ParameterValuesEntry
	...
	68, // 27: cluster_services.v1.GitopsCluster.annotations:type_name -> cluster_services.v1.GitopsCluster.AnnotationsEntry
	69, // 28: cluster_services.v1.GitopsCluster.labels:type_name -> cluster_services.v1.GitopsCluster.LabelsEntry
	...
	70, // 33: cluster_services.v1.CapiCluster.annotations:type_name -> cluster_services.v1.CapiCluster.AnnotationsEntry
	71, // 34: cluster_services.v1.CapiCluster.labels:type_name -> cluster_services.v1.CapiCluster.LabelsEntry
	...
	72, // 39: cluster_services.v1.Template.annotations:type_name -> cluster_services.v1.Template.AnnotationsEntry
	49, // 40: cluster_services.v1.Profile.maintainers:type_name -> cluster_services.v1.Maintainer
	73, // 41: cluster_services.v1.Profile.annotations:type_name -> cluster_services.v1.Profile.AnnotationsEntry
	50, // 42: cluster_services.v1.Profile.helm_repository:type_name -> cluster_services.v1.HelmRepository
	75, // 43: cluster_services.v1.PolicyParam.value:type_name -> google.protobuf.Any
	74, // 44: cluster_services.v1.PolicyTargetLabel.values:type_name -> cluster_services.v1.PolicyTargetLabel.ValuesEntry
	57, // 45: cluster_services.v1.PolicyTargets.labels:type_name -> cluster_services.v1.PolicyTargetLabel
	59, // 46: cluster_services.v1.Policy.standards:type_name -> cluster_services.v1.PolicyStandard
	56, // 47: cluster_services.v1.Policy.parameters:type_name -> cluster_services.v1.PolicyParam
	58, // 48: cluster_services.v1.Policy.targets:type_name -> cluster_services.v1.PolicyTargets
	61, // 49: cluster_services.v1.ListEventsRequest.involvedObject:type_name -> cluster_services.v1.ObjectRef
	62, // 50: cluster_services.v1.ListEventsResponse.events:type_name -> cluster_services.v1.Event
	0,  // 51: cluster_services.v1.ClustersService.ListTemplates:input_type -> cluster_services.v1.ListTemplatesRequest
	4,  // 52: cluster_services.v1.ClustersService.GetTemplate:input_type -> cluster_services.v1.GetTemplateRequest
	6,  // 53: cluster_services.v1.ClustersService.ListTemplateParams:input_type -> cluster_services.v1.ListTemplateParamsRequest
	8,  // 54: cluster_services.v1.ClustersService.ListTemplateProfiles:input_type -> cluster_services.v1.ListTemplateProfilesRequest
	10, // 55: cluster_services.v1.ClustersService.RenderTemplate:input_type -> cluster_services.v1.RenderTemplateRequest
	12, // 56: cluster_services.v1.ClustersService.ListGitopsClusters:input_type -> cluster_services.v1.ListGitopsClustersRequest
	24, // 57: cluster_services.v1.ClustersService.CreatePullRequest:input_type -> cluster_services.v1.CreatePullRequestRequest
	28, // 58: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:input_type -> cluster_services.v1.CreateTfControllerPullRequestRequest
	31, // 59: cluster_services.v1.ClustersService.DeleteClustersPullRequest:input_type -> cluster_services.v1.DeleteClustersPullRequestRequest
	33, // 60: cluster_services.v1.ClustersService.ListCredentials:input_type -> cluster_services.v1.ListCredentialsRequest
	35, // 61: cluster_services.v1.ClustersService.GetKubeconfig:input_type -> cluster_services.v1.GetKubeconfigRequest
	47, // 62: cluster_services.v1.ClustersService.GetEnterpriseVersion:input_type -> cluster_services.v1.GetEnterpriseVersionRequest
	53, // 63: cluster_services.v1.ClustersService.GetConfig:input_type -> cluster_services.v1.GetConfigRequest
	15, // 64: cluster_services.v1.ClustersService.ListPolicies:input_type -> cluster_services.v1.ListPoliciesRequest
	14, // 65: cluster_services.v1.ClustersService.GetPolicy:input_type -> cluster_services.v1.GetPolicyRequest
	18, // 66: cluster_services.v1.ClustersService.ListPolicyValidations:input_type -> cluster_services.v1.ListPolicyValidationsRequest
	20, // 67: cluster_services.v1.ClustersService.GetPolicyValidation:input_type -> cluster_services.v1.GetPolicyValidationRequest
	63, // 68: cluster_services.v1.ClustersService.ListEvents:input_type -> cluster_services.v1.ListEventsRequest
	3,  // 69: cluster_services.v1.ClustersService.ListTemplates:output_type -> cluster_services.v1.ListTemplatesResponse
	5,  // 70: cluster_services.v1.ClustersService.GetTemplate:output_type -> cluster_services.v1.GetTemplateResponse
	7,  // 71: cluster_services.v1.ClustersService.ListTemplateParams:output_type -> cluster_services.v1.ListTemplateParamsResponse
	9,  // 72: cluster_services.v1.ClustersService.ListTemplateProfiles:output_type -> cluster_services.v1.ListTemplateProfilesResponse
	11, // 73: cluster_services.v1.ClustersService.RenderTemplate:output_type -> cluster_services.v1.RenderTemplateResponse
	13, // 74: cluster_services.v1.ClustersService.ListGitopsClusters:output_type -> cluster_services.v1.ListGitopsClustersResponse
	25, // 75: cluster_services.v1.ClustersService.CreatePullRequest:output_type -> cluster_services.v1.CreatePullRequestResponse
	29, // 76: cluster_services.v1.ClustersService.CreateTfControllerPullRequest:output_type -> cluster_services.v1.CreateTfControllerPullRequestResponse
	32, // 77: cluster_services.v1.ClustersService.DeleteClustersPullRequest:output_type -> cluster_services.v1.DeleteClustersPullRequestResponse
	34, // 78: cluster_services.v1.ClustersService.ListCredentials:output_type -> cluster_services.v1.ListCredentialsResponse
	76, // 79: cluster_services.v1.ClustersService.GetKubeconfig:output_type -> google.api.HttpBody
	48, // 80: cluster_services.v1.ClustersService.GetEnterpriseVersion:output_type -> cluster_services.v1.GetEnterpriseVersionResponse
	54, // 81: cluster_services.v1.ClustersService.GetConfig:output_type -> cluster_services.v1.GetConfigResponse
	17, // 82: cluster_services.v1.ClustersService.ListPolicies:output_type -> cluster_services.v1.ListPoliciesResponse
	16, // 83: cluster_services.v1.ClustersService.GetPolicy:output_type -> cluster_services.v1.GetPolicyResponse
	19, // 84: cluster_services.v1.ClustersService.ListPolicyValidations:output_type -> cluster_services.v1.ListPolicyValidationsResponse
	21, // 85: cluster_services.v1.ClustersService.GetPolicyValidation:output_type -> cluster_services.v1.GetPolicyValidationResponse
	64, // 86: cluster_services.v1.ClustersService.ListEvents:output_type -> cluster_services.v1.ListEventsResponse
