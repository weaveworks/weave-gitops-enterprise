...
func (UnimplementedTemplateServiceServer) ListTemplateParams(context.Context, *ListTemplateParamsRequest) (*ListTemplateParamsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTemplateParams not implemented")
}
func (UnimplementedTemplateServiceServer) ListTemplateProfiles(context.Context, *ListTemplateProfilesRequest) (*ListTemplateProfilesResponse, error) {
...
func _TemplateService_ListTemplateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTemplateParamsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TemplateServiceServer).ListTemplateParams(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _TemplateService_ListTemplateProfiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTemplateProfilesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TemplateServiceServer).ListTemplateProfiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var TemplateService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TemplateService_ListTemplateParams_Handler,
		},
		{
			MethodName: "ListTemplateProfiles",
			Handler:    _TemplateService_ListTemplateProfiles_Handler,
		},
		{
...
// TfControllerServiceClient is the client API for TfControllerService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type TfControllerServiceClient interface {
...
type tfControllerServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewTfControllerServiceClient(cc grpc.ClientConnInterface) TfControllerServiceClient {
	return &tfControllerServiceClient{cc}
}
...
// TfControllerServiceServer is the server API for TfControllerService service.
// All implementations must embed UnimplementedTfControllerServiceServer
// for forward compatibility
type TfControllerServiceServer interface {
	// Creates a pull request for a tfcontroller template.
	// The template name and values will be used to
	// create a new branch for which a new pull request
	// will be created.
	...
	mustEmbedUnimplementedTfControllerServiceServer()
}

// UnimplementedTfControllerServiceServer must be embedded to have forward compatible implementations.
type UnimplementedTfControllerServiceServer struct {
}

func (UnimplementedTfControllerServiceServer) CreateTfControllerPullRequest(context.Context, *CreateTfControllerPullRequestRequest) (*CreateTfControllerPullRequestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTfControllerPullRequest not implemented")
}
func (UnimplementedTfControllerServiceServer) mustEmbedUnimplementedTfControllerServiceServer() {}

// UnsafeTfControllerServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to TfControllerServiceServer will
// result in compilation errors.
type UnsafeTfControllerServiceServer interface {
	mustEmbedUnimplementedTfControllerServiceServer()
}

func RegisterTfControllerServiceServer(s grpc.ServiceRegistrar, srv TfControllerServiceServer) {
	s.RegisterService(&TfControllerService_ServiceDesc, srv)
}

func _TfControllerService_CreateTfControllerPullRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTfControllerPullRequestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TfControllerServiceServer).CreateTfControllerPullRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
// TfControllerService_ServiceDesc is the grpc.ServiceDesc for TfControllerService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TfControllerService_CreateTfControllerPullRequest_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cluster_services.proto",
