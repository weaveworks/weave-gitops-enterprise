...
const (
	...
	ClustersService_CreateDeletionPullRequest_FullMethodName     = "/cluster_services.v1.ClustersService/CreateDeletionPullRequest"
...
type ClustersServiceClient interface {
	...
	// List the profiles of a template
	//
	// Includes default and required profiles specified by the template
	...
	//
	// In the request include one of the resources originally generated by the template.
	// Then a pull request will be created to delete all resources generated by the template.
...
func (c *clustersServiceClient) CreateDeletionPullRequest(ctx context.Context, in *CreateDeletionPullRequestRequest, opts ...grpc.CallOption) (*CreateDeletionPullRequestResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClustersService_CreateDeletionPullRequest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClustersService_CreateDeletionPullRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClustersService_CreateDeletionPullRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
