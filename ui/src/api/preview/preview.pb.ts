...
export class PreviewService {
  ...
  static CreatePullRequest(req: PreviewV1Types.CreatePullRequestRequest, initReq?: fm.InitReq): Promise<PreviewV1Types.CreatePullRequestResponse> {
    return fm.fetchReq<PreviewV1Types.CreatePullRequestRequest, PreviewV1Types.CreatePullRequestResponse>(`/v1/pull-requests`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
}